...
export default function Menu() {
  ...
  return (
    <div className="mt-12 flex flex-col gap-y-4 text-gray-500 fill-gray-500 text-sm">
      ...
      {/* COMMUNITY */}
      <a
        className="flex items-center space-x-2 py-1 group hover:border-r-4 hover:border-r-red-600 hover:font-bold  "
        href="#"
      >
        <svg
      ...
      <a
 className="
flex items-center space-x-2 py-1 group
      ...
      <a className="flex items-center space-x-2 py-1 mt-4" href="#">
        <div className="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
          <input
            ...
            className="absolute left-0 top-0 w-6 h-6 rounded-full bg-white border-4 border-gray-300 appearance-none cursor-pointer transition-transform duration-300 checked:translate-x-4"
          />
          <label
            htmlFor="toggle"
         ...
         <label htmlFor="toggle" className="text-gray-500 fill-gray-500 text-sm ">
